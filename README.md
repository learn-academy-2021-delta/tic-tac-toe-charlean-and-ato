...
//.css updated the square and gameboard
//App.js invoke component call with div className to allow css attributes, display with {this.state.gameboard}
(Done)
- As a user, I should be able to click on a square to mark it.
//onclick in the square.js
//make handleGamePlay() on the app.js between constructor and render
